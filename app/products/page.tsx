        ...
        <div className={`${cx} h-14 flex items-center justify-between gap-4`}>
          ...
          <div className={`flex items-center gap-3 min-w-0 ${isRTL ? 'flex-row-reverse' : ''}`}>
            <button
              ...
              className={`flex items-center gap-2 h-8 px-4 border text-[11px] font-bold tracking-[0.12em] uppercase transition-colors flex-shrink-0 ${
                isFilterOpen
          ...
          <div className="relative flex-shrink-0">
            <select
              ...
              className="h-8 pl-3 pr-8 bg-transparent border border-[#2D1F1F]/20 text-[11px] font-bold tracking-[0.1em] uppercase appearance-none cursor-pointer hover:border-[#C9A84C] focus:outline-none focus:border-[#C9A84C] text-[#2D1F1F]"
            >
              {sortOptions.map(opt => (
        ...
        <div className="flex gap-8 lg:gap-12">
          ...
          <AnimatePresence>
            {isFilterOpen && (
              ...
              >
                <div className="w-[220px] sticky top-[110px]">
                  {/* Categories */}
                  <div className="mb-8">
                      ...
                      {categories.map(cat => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-[12px] text-[#2D1F1F]/70 group-hover:text-[#2D1F1F] transition-colors">
                              {language === 'ar' ? cat.nameAr : cat.name}
                            </span>
                          </div>
