...
export const banners: Banner[] = [
  /* ── home_hero ── */
  {
    id: 'bn1',
    placement: 'home_hero',
    title: 'Beauty, Beautifully Curated',
    titleAr: 'جمال مُنسّق بعناية',
    subtitle: 'Discover premium makeup, perfumes and skincare from the brands you love',
    subtitleAr: 'اكتشف المكياج والعطور والعناية الفاخرة من العلامات التي تحبّها',
    buttonText: 'Shop Makeup',
    buttonTextAr: 'تسوق المكياج',
    ...art('makeup,cosmetics', 'bn1'),
    linkType: 'category',
    target: { categorySlug: 'makeup' },
    bgColor: '#2D1F1F',
    textColor: '#F5F0E8',
  },
  {
    ...
    titleAr: 'فن العطر',
    subtitle: 'From Amouage to everyday mists — signature scents for every moment',
    subtitleAr: 'من أموآج إلى المعطرات اليومية — عطور مميّزة لكل لحظة',
    buttonText: 'Shop Perfumes',
    buttonTextAr: 'تسوق العطور',
    ...art('perfume,luxury', 'bn2'),
    linkType: 'category',
    target: { categorySlug: 'perfumes' },
    bgColor: '#1a0a00',
    textColor: '#E8D5A3',
  },
  {
    ...
    subtitle: 'Curated bundles for weddings, Ramadan, Eid, newborns and every occasion',
    subtitleAr: 'باقات منسّقة للأعراس ورمضان والعيد والمواليد وكل مناسبة',
    buttonText: 'Shop Gifts',
    buttonTextAr: 'تسوق الهدايا',
    ...art('gift,box', 'bn3'),
    linkType: 'category',
    target: { categorySlug: 'gifts' },
    bgColor: '#1A2A1A',
    textColor: '#F5F0E8',
  },
  ...
  /* ── home_middle ── product_listing (a curated, filtered listing) ── */
  {
    ...
    title: 'Healthy Living, On Offer',
    titleAr: 'حياة صحية، بأسعار مخفّضة',
    subtitle: 'Proteins, sugar-free snacks & wellness — now discounted',
    subtitleAr: 'بروتينات ووجبات خالية من السكر ومنتجات العافية — الآن بخصم',
    buttonText: 'Shop the Edit',
    buttonTextAr: 'تسوق التشكيلة',
    ...art('protein,health', 'bn4'),
    linkType: 'product_listing',
    target: { filters: { category: 'health-nutrition', has_discount: 1 } },
    bgColor: '#1A2A1A',
    textColor: '#F5F0E8',
  },
  {
